...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-xl border bg-card/95 text-card-foreground shadow-[0_18px_55px_rgba(11,45,99,0.08)]',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'font-display text-2xl font-medium leading-tight tracking-normal text-primary',
      className,
    )}
    {...props}
  />
